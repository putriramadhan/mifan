...
<!--Page Heading-->
   ...
   <form action="/slider/{{$slider->id}}" method="POST" enctype="multipart/form-data">
       ...
       <div class="form-group">
           ...
           <input type="text" class="form-control" id="judul" name="judul" value="{{old('judul') ? old('judul') : $slider->judul}}">
        ...
        <img src="/upload/slider/{{$slider->banner}}" alt="" width="150px" height="100px">
        <div class="form-group">
